/**
 * Reusable SVG icons for the admin dashboard and UI components.
 * All icons accept className for styling (size, color).
 */
...
export function ProjectsIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function MediaIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
